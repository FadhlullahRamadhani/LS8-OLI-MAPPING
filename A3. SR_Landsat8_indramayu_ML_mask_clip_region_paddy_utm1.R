...
library(raster)
library(rgdal)
indramayu_region <- readOGR("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm/SHP","indramayu_land_utm")
indramayu_paddy <- readOGR("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm/SHP","paddy_utm")
  ...
  for (model_ML in model) {
    ...
    for(i_preName in 1:1) {
      try({
        ...
        folder_mask <- paste("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm/LS8-FMASK-MERGE/",collapse = "",sep = "")
        setwd(folder_mask)
        search_str <- paste("*",i_datels8,".*",".*[.]tif$",sep = "")
        fmask.rasters <- lapply(list.files(pattern=search_str), raster)
        fmask_current <- fmask.rasters[[1]]
        
        folder_merge <- paste("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm/CLASSIFY-MERGE/",model_ML,"/",collapse = "",sep = "")
        setwd(folder_merge)
        ...
        #plot(raster_mask)
        #REGION-MASK
        folder_clip_region_mask <- paste("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm/REGION-MASK/",model_ML,"/",collapse = "",sep = "")
        ...
        #region
        folder_clip_region <- paste("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm/CLIP-REGION-MASK/",model_ML,"/",collapse = "",sep = "")
