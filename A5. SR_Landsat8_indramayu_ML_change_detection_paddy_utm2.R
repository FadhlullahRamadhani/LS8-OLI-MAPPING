...
for(i_datels8 in 1:1) {
  ...
  for (model_ML in model) {
    ...
    for(i_preName in 1:1) {
       ...
       folder_result_paddy <- paste("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm-2018/CHANGE-DETECTION/",collapse = "",sep = "")
       dir.create(folder_result_paddy, showWarnings = FALSE)
       folder_result_paddy <- paste("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm-2018/CHANGE-DETECTION/",model_ML,"/",collapse = "",sep = "")
       dir.create(folder_result_paddy, showWarnings = FALSE)
