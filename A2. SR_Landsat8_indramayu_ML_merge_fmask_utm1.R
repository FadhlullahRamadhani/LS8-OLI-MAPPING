...
mainDir <- "C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm/LS8-FMASK/"
setwd(mainDir)
...
for (i_datels8 in datels8){
        ...
        folder_merge <- paste("C:/MasseyOffice1/Research/R-Script/SR-LS8-indramayu-utm/LS8-FMASK-MERGE/",collapse = "",sep = "")
