...
for i in range(1, 14):
	LS8_Collection = ee.ImageCollection('LANDSAT/LC08/C01/T1_SR').filterDate('2017-05-01','2019-12-01')
	...
	for j in range(0, n):
		...
		id = img.id().getInfo();
		filename = 'LS8-SR-FMASK-' + id 
		fullname_check = "F:\\RS_images\\LS8-SR-utm-FMASK\\" + filename +  '.tif'
